        ...
        <header class="profile__header">
            ...
            <div class="profile__column">
                <div class="profile__title">
                    ...
                    <a href="delete-photo.html">Delete Photo</a>
                ...
                <p class="profile__bio">
                    ...
                    <a href="https://www.youtube.com/channel/UC5VwPtGkSMSoKPccaZAPSXQ?view_as=subscriber"><?php echo $_SESSION['profile']['website']; ?></a>
                </p>
            </div>
        </header>
